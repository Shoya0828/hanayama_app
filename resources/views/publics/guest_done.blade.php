...
<header>
  ...
  <div class="progress mx-5 mb-5" style="height: 50px;">
    ...
    <div class="progress-bar fs-6" role="progressbar" style="width: 25%; border: 1px solid white;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">ご確認
    </div>

    <div class="progress-bar fs-6 fw-bold" role="progressbar" style="width: 25%; border: 1px solid white;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">完了
    </div>
  </div>
</header>
...
<body>
  <div class="container pt-5 mt-5">
    <div class="row m-5 text-center">
      <div class="fs-3">ご購入ありがとうございます</div>
    </div>

    <div class="row mx-5 d-flex justify-content-center align-items-center">
      <div class="col-2 fw-bold border" style="width:120px;">オーダー番号</div>
      <div class="col-3 fw-bold border text-center">{{ $orderId }}</div>
    </div>
  </div>
