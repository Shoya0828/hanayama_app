  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col p-3 d-flex justify-content-center align-items-center">
        <input type="password" class="form-control" id="inputPassword" placeholder="パスワード" style="width:40%">
      </div>
    </div>

    <div class="row">
      <div class="col p-3 d-flex justify-content-center align-items-center">
        <input type="password" class="form-control" id="inputRepassword" placeholder="パスワード(再入力)" style="width:40%">
      </div>
    </div>

    <div class="row">
      <div class="d-flex justify-content-center p-3">
        <a href="{{ route('forget_done') }}" type="submit" id="button" name="confirm" class="form-control btn btn-primary btn-lg" style="width: auto">パスワードをリセットする</a>
      </div>
    </div>
